      ...
      <Flex justifyContent="Center" maxWidth="100%">
        <motion.div initial={{ opacity: 0}} whileInView={{ opacity: 1 }}>
          <VStack spacing={5}>
            ...
            <Text align="center" px="10%">Blockchain can be a confusing topic. Dont know where to start? KUBIs got you! You will find plenty of resources here to expand your blockchain knowledge between Block Talks to explain the basics of blockchain, weekly newsletters to highlight important blockchain topics, and articles written by our team to express the use cases of blockchain.</Text>
            <br></br>
          </VStack> 
        </motion.div>
      </Flex>
